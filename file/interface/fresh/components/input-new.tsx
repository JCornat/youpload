    ...
    <div class="relative flex flex-col">
      <div class="relative z-0">
        <input
          ...
          placeholder=" "/>
        <label class="pointer-events-none absolute text-gray-500 bg-neutral-50 peer-disabled:bg-neutral-200 duration-300 transform px-1 -translate-y-7 scale-75 top-4 z-10 origin-[0] left-4 peer-focus:left-4 peer-focus:text-primary-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-7 peer-focus:bg-neutral-50 peer-focus:px-1 peer-invalid:text-error-600">{props.label ?? 'Input'}</label>
      </div>
